              ...
              <hr/>
							...
							if(!empty($email))
							{
								if(isset($_POST['g-recaptcha-response']))
									...
									if(!$captcha){
														echo "<div class=\"alert alert-danger\" role=\"alert\">Please check captcha form</div>";
													//exit;
												}
							...
							if($response['success'] == false)
									...
									if($stmt->execute())
									{
										...
										if($query_num_rows==0)
										...
										else
											{
												...
												//Set the body
												$mail->Body = "Here is your password reset link-> "."xtasy.cetb.in/users/passwordreset/index.php?account=$email&token=".md5($user_id.$salt);
								...
								echo "<div class=\"alert alert-danger\" role=\"alert\">Please Enter Email</div>";
							}
						}
	?>
                  ...
                  <div id="email-error"></div>
                          ...
                          <div class="form-group col-md-12 no-margin">
                            <div class="g-recaptcha" data-sitekey="6LfooxUTAAAAAC8n3jI_C5cuvk4F3y_9wTLhzE6X"></div>
                          </div>
